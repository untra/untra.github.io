...
var list = ["Linux User 💻", "Flannel Fiend 👕", "Peach SSMB 🍑", "French House Aficionado 🎹", "Beer Connoisseur 🍻", "Coloradan 🏴󠁵󠁳󠁣󠁯󠁿", "Boulderite 🌄", "Ski Bum ⛷", "Grill Master 🍖", "Lord of the Dance 🕺", "Nice Young Jewish Boy 👨", "'); DROP TABLE Posts;--", "something else I forget", "Untra 💎", "AV Clubber 📼", "Danger Noodle 🐍", "Rad Dude 👈😎👈", "Your Friend 👈😎👈", "chicken n egg problems 🐣", "ISO 8601 compliant ⏱️", "ISO/IEC 19790 & FIPS 140-3 🧮", "Flying the Coop 🐤", "Quinoa Salad 💕", "Jack of all trades", "Main of none", "lololololol" ];
